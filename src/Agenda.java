import java.util .*;
    ...
    public class Agenda {
        ...
        public static void main(String args[]) {
            ...
            a.afegirContacte("Casa", "");

            a.mostrarAgenda();

            a.inserirArray(contactes);
        ...
        public void afegirContacte(String nom, String telefon) {
            this.persones.put(nom, telefon);

        }
        public void inserirArray(String[] c){
            for (int i = 0; i < c.length; i++) {
                this.persones.put(c[i],"");
            }
        }
    }
